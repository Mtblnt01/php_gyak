<?php 
    if (isset($_POST["submit"])){
        try {
            ...
            //2. A feltöltési mappa létezése vagy írása
            ...
            //5 fájl tipusanak ellenőrzése
            if (!in_array($fileType, ["jpg", "jpeg", "png", "gif"])) {
                throw new Exception("Nem megfelelő a fájl tipusa [jpg, jpeg, png, gif]!");
            }

            //fájl áthelyezése temp -> target be
            if (move_uploaded_file($tempFileName, $targetFile)) {
                echo "Sikeresen feltöltve a $targetFile.";
            } else {}
